 ...
 * provided, obtaining the data from the  by creating a {@link android.support.v4.content.CursorLoader} and then parsing the
...
public interface Model<Q extends QueryEnum, UA extends UserActionEnum> {
     ...
     */
    public void deliverUserAction(UA action, @Nullable Bundle args, UserActionCallback<UA> callback);
